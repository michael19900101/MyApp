...
import com.aotuman.myapp.bezier.ThirdBezierView;

/**
 * Created by aotuman on 2017/2/23.
 */

public class ThirdBezierViewFragment extends Fragment {
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ThirdBezierView thirdBezierView = new ThirdBezierView(getActivity());
        linearLayout.addView(thirdBezierView);
        return linearLayout;
    }
}
